...
from open_diloco.fsdp_diloco_native import ddp_setup, destroy_process_group
...
def test_fsdp_diloco_native(simple_ddp_environment):
    train(lr=1e-2, total_batch_size=32, per_device_train_batch_size=8, max_steps=10)
